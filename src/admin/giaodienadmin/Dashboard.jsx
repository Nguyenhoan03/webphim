...
export default function Dashboard() {
  ...
  useEffect(()=>{
    axios.get(`${process.env.REACT_APP_BASEURL}/api/dulieuadmin`)
    .then(response=>{
  ...
  return (
    ...
    <p class="lead d-none d-sm-block" style={{fontWeight:550,color:'red',fontFamily:'monospace'}}>THỐNG KÊ FILM</p>
        ...
        <div class="col-xl-3 col-sm-6 py-2">
            <div class="card bg-success text-white h-100">
                <div class="card-body bg-success" style={{backgroundColor:"#57b960"}}>
                    ...
                    <h6 class="text-uppercase">Danh mục film</h6>
        ...
        <div class="col-xl-3 col-sm-6 py-2">
            <div class="card text-white bg-danger h-100">
                <div class="card-body bg-danger">
                    ...
                    <h6 class="text-uppercase">Tổng film lẻ,chiếu rạp</h6>
                    <h1 class="display-4">{count.tongfilmlecr}</h1>
                </div>
            </div>
        </div>
        <div class="col-xl-3 col-sm-6 py-2">
            <div class="card text-white bg-info h-100">
                <div class="card-body bg-info">
                    ...
                    <h6 class="text-uppercase">Số Quốc gia film</h6>
        ...
        <div class="col-xl-3 col-sm-6 py-2">
            <div class="card text-white bg-warning h-100">
                <div class="card-body">
                    ...
                    <h6 class="text-uppercase">Tổng Film</h6>
                    <h1 class="display-4">{count.film}</h1>
                </div>
            </div>
        </div>
    </div>
